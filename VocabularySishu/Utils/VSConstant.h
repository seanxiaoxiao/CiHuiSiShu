...
#define SHORTTERM_REVIEW_INTERVAL 30;
#define LONGTERM_REVIEW_INTERVAL 60;
#define LONGTERM_EXPIRE_INTERVAL 50;
#define SHORTTERM_EXPIRE_INTERVAL 10;
#define NOTIFICATION_DENY 10;
